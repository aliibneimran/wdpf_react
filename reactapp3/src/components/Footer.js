          ...
          <div className="row g-4 footer-inner">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                <div className="d-flex flex-column align-items-start">
                  ...
                  <a className="btn btn-link ps-0" href="">
                    <i className="fa fa-check me-2"></i>Terms & Condition
                  </a>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                <div className="d-flex flex-column align-items-start">
                  <a className="btn btn-link ps-0" href="">
                    <i className="fa fa-check me-2"></i>Apartment Cleaning
                  </a>
                  <a className="btn btn-link ps-0" href="">
                    <i className="fa fa-check me-2"></i>Office Cleaning
                  </a>
                  <a className="btn btn-link ps-0" href="">
                    <i className="fa fa-check me-2"></i>Car Washing
                  </a>
                  <a className="btn btn-link ps-0" href="">
                    <i className="fa fa-check me-2"></i>Green Cleaning
                  </a>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                >
                  <i className="fa fa-map-marker-alt me-3"></i>123 Street, CA,
                  USA
                </a>
                <a
                  href=""
