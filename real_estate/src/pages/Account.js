                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="ltn__tab-menu-list mb-50">
                                                <div class="nav">
                                                    <Link class="active show" data-bs-toggle="tab" to="/#ltn_tab_1_1">Dashboard <i class="fas fa-home"></i></Link>
                                                    <Link data-bs-toggle="tab" to="/#ltn_tab_1_2">Profiles <i class="fas fa-user"></i></Link>
                                                    <Link data-bs-toggle="tab" to="/#ltn_tab_1_3">address <i class="fas fa-map-marker-alt"></i></Link>
                                                    <Link data-bs-toggle="tab" to="/#ltn_tab_1_4">Account Details <i class="fas fa-user"></i></Link>
                                                    <Link data-bs-toggle="tab" to="/#ltn_tab_1_5">My Properties <i class="fa-solid fa-list"></i></Link>
                                                    <Link data-bs-toggle="tab" to="/#ltn_tab_1_6">Favorited Properties <i class="fa-solid fa-heart"></i></Link>
                                                            ...
                                                            <div class="ltn__form-box contact-form-box box-shadow white-bg">
                                                                ...
                                                                <form id="contact-form" action="mail.php" method="post">
                                                                    ...
                                                                    <div class="input-item input-item-textarea ltn__custom-icon">
                                                                        <textareLink name="message" placeholder="Enter message"></textareLink>
                                                                    </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                            ...
                                                                            <div class="ltn__my-properties-info">
                                                                                ...
                                                                                <div class="product-ratting">
                                                                                    <ul>
                                                                                        ...
                                                                                        <li class="review-total"> <Link to="/#"> ( 95 Reviews )</Link></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td><Link to="/#"><i class="fa-solid fa-trash-can"></i></Link></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="ltn__my-properties-img">
                                                    ...
                                                    <div class="ltn__myaccount-tab-content-inner">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="input-item input-item-textarea ltn__custom-icon">
                                                                    <textareLink name="ltn__message" placeholder="Description"></textareLink>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <h6>Virtual Tour</h6>
                                                        <div class="input-item input-item-textarea ltn__custom-icon">
                                                            <textareLink name="ltn__message" placeholder="Virtual Tour:"></textareLink>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="input-item input-item-textarea ltn__custom-icon">
                                                                        <textareLink name="ltn__message" placeholder="Owner/Agent notes (*not visible on front end)"></textareLink>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="ltn__checkout-inner">
                                                                        <div class="ltn__checkout-single-content ltn__returning-customer-wrap">
                                                                            <h5>Returning customer? <Link class="ltn__secondary-color" to="/#ltn__returning-customer-login" data-toggle="collapse">Click here to login</Link></h5>
                                                                        ...
                                                                        <div class="ltn__checkout-single-content ltn__coupon-code-wrap">
                                                                            <h5>Have a coupon? <Link class="ltn__secondary-color" to="/#ltn__coupon-code" data-toggle="collapse">Click here to enter your code</Link></h5>
                                                                        ...
                                                                        <div class="ltn__checkout-single-content mt-50">
                                                                            ...
                                                                            <div class="ltn__checkout-single-content-info">
                                                                                <form action="#" >
                                                                                    ...
                                                                                    <div class="input-item input-item-textarea ltn__custom-icon">
                                                                                        <textareLink name="ltn__message" placeholder="Notes about your order, e.g. special notes for delivery."></textareLink>
                                                                                    </div>
