...
<div>
      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <div className="ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center">
            <div className="nav">
              <Link data-bs-toggle="tab" to="/#liton_tab_3_1">The Studio</Link>
              <Link className="active show" data-bs-toggle="tab" to="/#liton_tab_3_2">Deluxe Portion</Link>
              <Link data-bs-toggle="tab" to="/#liton_tab_3_3" className>Penthouse</Link>
              <Link data-bs-toggle="tab" to="/#liton_tab_3_4" className>Top Garden</Link>
              <Link data-bs-toggle="tab" to="/#liton_tab_3_5" className>Double Height</Link>
            </div>
          </div>
  ...
  <div className="ltn__search-by-place-area before-bg-top bg-image-top--- pt-115 pb-70" data-bs-bg="assets/img/bg/20.jpg">
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          <div className="section-title-area ltn__section-title-2--- text-center---">
      ...
      <div className="row ltn__search-by-place-slider-1-active slick-arrow-1">
        <div className="col-lg-4">
          <div className="ltn__search-by-place-item">
            ...
            <div className="search-by-place-info">
              <h6><Link to="/locations">San Francisco</Link></h6>
        ...
        <div className="col-lg-4">
          <div className="ltn__search-by-place-item">
            ...
            <div className="search-by-place-info">
              <h6><Link to="/locations">New York</Link></h6>
        ...
        <div className="col-lg-4">
          <div className="ltn__search-by-place-item">
            ...
            <div className="search-by-place-info">
              <h6><Link to="/locations">Sedona, Arizona</Link></h6>
          ...
          <div className="ltn__select-availability-table-wrap">
            <div className="ltn__select-availability-table d-none d-md-block">
              ...
              <ul className="ltn__select-availability-table-row">
                ...
                <li>1,200 </li>
                <li>$3,500</li>
                <li><Link to="/product-details">+ Available</Link></li>
              </ul>
              <ul className="ltn__select-availability-table-row">
                <li className="tower-name">Tower Name</li>
                <li>3</li>
            ...
            <div className="ltn__select-availability-table-responsive d-md-none">
              <ul className="ltn__select-availability-table-row-responsive-item">
                ...
                <li><span>Details</span> <span><Link to="/product-details">+ Available</Link></span></li>
              </ul>
              <ul className="ltn__select-availability-table-row-responsive-item">
                <li><span>Residence</span> <span className="tower-name">Tower Name</span></li>
                <li><span>Bedrooms</span> <span>3</span></li>
        ...
        <div className="col-lg-12">
          <div className="ltn__neighbour-tab-wrap">
            <div className="ltn__tab-menu ltn__tab-menu-3--- ltn__tab-menu-4 ltn__tab-menu-top-right-- text-uppercase--- text-center">
              <div className="nav">
                <Link className="active show" data-bs-toggle="tab" to="/#liton_tab_4_1"><img src="assets/img/neighbour/1.jpg" alt="#" /></Link>
                <Link data-bs-toggle="tab" to="/#liton_tab_4_2" className><img src="assets/img/neighbour/2.jpg" alt="#" /></Link>
                <Link data-bs-toggle="tab" to="/#liton_tab_4_3" className><img src="assets/img/neighbour/3.jpg" alt="#" /></Link>
              </div>
            </div>
            <div className="tab-content">
  ...
  <div className="ltn__testimonial-area section-bg-1--- bg-image-top pt-115 pb-65" data-bs-bg="assets/img/bg/23.jpg">
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          <div className="section-title-area ltn__section-title-2--- text-center---">
  ...
  <div className="ltn__call-to-action-area call-to-action-6 before-bg-bottom" data-bs-bg="assets/img/1.jpg--">
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
