                        ...
                        <div className="row ltn__image-slider-5-active slick-arrow-1 slick-arrow-1-inner ltn__no-gutter-all">
                            <div className="col-lg-12">
                                <div className="ltn__img-slide-item-4">
                                    <Link to="/img/img-slide/31.jpg" data-rel="lightcase:myCollection">
                            ...
                            <div className="col-lg-12">
                                <div className="ltn__img-slide-item-4">
                                    <Link to="/img/img-slide/32.jpg" data-rel="lightcase:myCollection">
                            ...
                            <div className="col-lg-12">
                                <div className="ltn__img-slide-item-4">
                                    <Link to="/img/img-slide/33.jpg" data-rel="lightcase:myCollection">
                            ...
                            <div className="col-lg-12">
                                <div className="ltn__img-slide-item-4">
                                    <Link to="/img/img-slide/34.jpg" data-rel="lightcase:myCollection">
                            ...
                            <div className="col-lg-12">
                                <div className="ltn__img-slide-item-4">
                                    <Link to="/img/img-slide/35.jpg" data-rel="lightcase:myCollection">
                                ...
                                <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                                    <div className="ltn__blog-meta">
                                        <ul>
                                            ...
                                            <li className="ltn__blog-category">
                                                <Link className="bg-orange" href="#">{item.type}</Link>
                                            </li>
                                    ...
                                    <h1>{item.title}</h1>
                                    <label><span className="ltn__secondary-color"><i className="flaticon-pin" /></span> {item.address}</label>
                                    ...
                                    <div className="property-detail-info-list section-bg-1 clearfix mb-60">
                                        <ul>
                                            ...
                                            <li><label>Home Area: </label> <span>{item.size} sqft</span></li>
                                            <li><label>Rooms:</label> <span>{item.bed}</span></li>
                                            <li><label>Baths:</label> <span>{item.bath}</span></li>
                                        ...
                                        <ul>
                                            ...
                                            <li><label>Beds:</label> <span>{item.bed}</span></li>
                                            <li><label>Price:</label> <span>{item.price}</span></li>
                                            <li><label>Property Status:</label> <span>{item.type}</span></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="ltn__property-details-gallery mb-30">
                                        <div className="row">
                                            <div className="col-md-6">
                                                <Link to="/img/others/14.jpg" data-rel="lightcase:myCollection">
                                                    <img className="mb-30" src="assets/img/others/14.jpg" alt="Image" />
                                                </Link>
                                                <Link to="/img/others/15.jpg" data-rel="lightcase:myCollection">
                                                    <img className="mb-30" src="assets/img/others/15.jpg" alt="Image" />
                                                </Link>
                                            </div>
                                            <div className="col-md-6">
                                                <Link to="/img/others/16.jpg" data-rel="lightcase:myCollection">
                                                    <img className="mb-30" src="assets/img/others/16.jpg" alt="Image" />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="ltn__apartments-plan-area product-details-apartments-plan mb-60">
                                        <div className="ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center---">
                                            <div className="nav">
                                                <Link data-bs-toggle="tab" href="#liton_tab_3_1">First Floor</Link>
                                                <Link className="active show" data-bs-toggle="tab" href="#liton_tab_3_2">Second Floor</Link>
                                                <Link data-bs-toggle="tab" href="#liton_tab_3_3" className>Third Floor</Link>
                                                <Link data-bs-toggle="tab" href="#liton_tab_3_4" className>Top Garden</Link>
                                            </div>
                                        </div>
                                    ...
                                    <div className="ltn__video-bg-img ltn__video-popup-height-500 bg-overlay-black-50 bg-image mb-60" data-bs-bg="img/others/5.jpg">
                                        <Link className="ltn__video-icon-2 ltn__video-icon-2-border---" href="https://www.youtube.com/embed/eWUxqVFBq74?autoplay=1&showinfo=0" data-rel="lightcase:myCollection">
                                        ...
                                        <div className="ltn__author-widget-inner text-center">
                                            ...
                                            <div className="product-ratting">
                                                <ul>
                                                    ...
                                                    <li><Link to="/#"><i className="fas fa-star-half-alt" /></Link></li>
                                                    <li><Link to="/#"><i className="far fa-star" /></Link></li>
                                                    <li className="review-total"> <Link to="/#"> ( 1 Reviews )</Link></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div className="ltn__social-media">
                                                <ul>
                                                    ...
                                                    <li><Link to="/#" title="Youtube"><i className="fab fa-youtube" /></Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
