                        ...
                        <div class="col-lg-12">
                            <form action="#">
                                <div class="ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center">
                                    <div class="nav">
                                        <Link class="active show" data-bs-toggle="tab" to="/#liton_tab_3_1">1. Description</Link>
                                        <Link data-bs-toggle="tab" to="/#liton_tab_3_2" class="">2. Media</Link>
                                        <Link data-bs-toggle="tab" to="/#liton_tab_3_3" class="">3. Location</Link>
                                        <Link data-bs-toggle="tab" to="/#liton_tab_3_4" class="">4. Details</Link>
                                        <Link data-bs-toggle="tab" to="/#liton_tab_3_5" class="">5. Amenities</Link>
                                    </div>
                                </div>
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="liton_tab_3_1">
                                        <div class="ltn__apartments-tab-content-inner">
                                            ...
                                            <div class="btn-wrapper text-center--- mt-0">
                                                ...
                                                <Link to="/#" class="btn theme-btn-1 btn-effect-1 text-uppercase" >Next Step</Link>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="liton_tab_3_2">
                                        <div class="ltn__product-tab-content-inner">
                                            ...
                                            <div class="btn-wrapper text-center--- mt-0">
                                                {/* <!-- <button type="submit" class="btn theme-btn-1 btn-effect-1 text-uppercase" >Next Step</button> --> */}
                                                <Link to="/#" class="btn theme-btn-1 btn-effect-1 text-uppercase" >Prev Step</Link>
                                                <Link to="/#" class="btn theme-btn-1 btn-effect-1 text-uppercase" >Next Step</Link>
                                            </div>
                                        </div>
                                    </div>
