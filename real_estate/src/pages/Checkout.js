                      ...
                      <div className="col-lg-12">
                          <div className="ltn__checkout-inner">
                              <div className="ltn__checkout-single-content ltn__returning-customer-wrap">
                                  <h5>Returning customer? <Link className="ltn__secondary-color" to="/#ltn__returning-customer-login" data-bs-toggle="collapse">Click here to login</Link></h5>
                              ...
                              <div className="ltn__checkout-single-content ltn__coupon-code-wrap">
                                  <h5>Have a coupon? <Link className="ltn__secondary-color" to="/#ltn__coupon-code" data-bs-toggle="collapse">Click here to enter your code</Link></h5>
