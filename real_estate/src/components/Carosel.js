            ...
            <div className="row">
              <div className="col-lg-12 align-self-center">
                <div className="slide-item-info">
                  <div className="slide-item-info-inner ltn__slide-animation">
                    <div className="slide-video mb-50 d-none">
                      <Link className="ltn__video-icon-2 ltn__video-icon-2-border" to="https://www.youtube.com/embed/tlThdr3O5Qo" data-rel="lightcase:myCollection">
                    ...
                    <div className="btn-wrapper animated">
                      <Link to="about.html" className="theme-btn-1 btn btn-effect-1">Make An Enquiry</Link>
                      <Link className="ltn__video-play-btn bg-white" to="https://www.youtube.com/embed/HnbMYzdjuBs?autoplay=1&showinfo=0" data-rel="lightcase">
                ...
                <div className="slide-item-img">
                  <img src="assets/img/slider/62.jpg" alt="#" />
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="slide-item-info">
                  <div className="slide-item-info-inner ltn__slide-animation">
                    ...
                    <div className="btn-wrapper animated">
                      ...
                      <Link to="about.html" className="btn btn-transparent btn-effect-3">LEARN MORE</Link>
                    </div>
                  </div>
                </div>
                <div className="slide-item-img">
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12 align-self-center">
                ...
                <div className="slide-item-img">
                  <img src="assets/img/slider/63.jpg" alt="#" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12 align-self-center">
                ...
                <div className="slide-item-img">
                  <img src="assets/img/slider/64.jpg" alt="#" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="ltn__slider-11-img-slide-arrow-inner">
        <div className="ltn__slider-11-img-slide-arrow-active">
          <div className="image-slide-item">
            <img src="assets/img/slider/61.jpg" alt="Flower Img" />
          </div>
          <div className="image-slide-item">
            <img src="assets/img/slider/62.jpg" alt="Flower Img" />
          </div>
          <div className="image-slide-item">
            <img src="assets/img/slider/63.jpg" alt="Flower Img" />
          </div>
          <div className="image-slide-item">
            <img src="assets/img/slider/64.jpg" alt="Flower Img" />
          </div>
        </div>
