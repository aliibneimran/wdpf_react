...
export default function CommingProject() {
  return (
    <>
              ...
              <section>
                ...
                <div className="z-hover img">
                  ...
                  <img
                    ...
                    src="images/project/bagal/feature-bagal-bilash.jpg"
                    alt="Mayer-Anchal"
                  />
                  {/* <!--======= IMAGE HOVER =========--> */}
            ...
            <li className="col-sm-4">
              ...
              <section>
                ...
                <div className="z-hover img">
                  ...
                  <img
                    className="img-responsive"
                    src="images/project/Shabuddin-Fortune/"
                    alt=""
                  />
                  {/* <!--======= IMAGE HOVER =========--> */}
                  <div className="over-proper">
            ...
            <li className="col-sm-4">
              ...
              <section>
                ...
                <div className="z-hover img">
                  ...
                  <img
                    className="img-responsive"
                    src="images/project/Spanish-Velabista"
                    alt=""
                  />
                  {/* <!--======= IMAGE HOVER =========--> */}
                  <div className="over-proper">
